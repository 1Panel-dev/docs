...
!!! note "问题修复 :palm_tree:"
    ...
    * 修复了 PHP 8.4.6 运行环境安装 imap 扩展失败的问题
    * 修复了部分情况下切换本地备份账号时数据迁移异常的问题
    * 修复了授权 IP 可被伪造的 X-Forwarded-For 请求绕过的问题
    * 修复了登录接口可被绕过验证码校验的问题
...
!!! note "问题修复 :palm_tree:"
    ...
    * 修复了开启 GPU 支持后应用升级查看对比时 GPU 配置丢失的问题
    * 修复了 OneDrive 默认客户端认证信息失效的问题
    * 修复了编辑 HTTPS 类型镜像仓库后 Docker 被默认重启的问题
    * 修复了部分页面 F12 控制台报错的问题
...
!!! note "功能优化 :sunflower:"
    ...
    * 【网站】PHP 运行环境新增 PbootCMS 扩展模板
    * 【容器】优化镜像仓库密码验证规则
    * 【容器】编辑 HTTP 镜像仓库时增加重启 Docker 提示
    * 【系统】新增支持 riscv64 架构
    * 【系统】新增对 procd、OpenRC 和 SysVinit 的支持

!!! note "问题修复 :palm_tree:"

    * 【容器】修复了 Macvlan 网络模式下容器升级后容器 IP 变化的问题
    * 【计划任务】修复了 Shell 脚本类型计划任务部分语法高亮显示异常的问题
    * 【计划任务】修复了计划任务备份文件大小偶发显示异常的问题
...
!!! note "功能优化 :sunflower:"
    ...
    * 【数据库】数据库设置页面默认显示当前状态
    * 【文件】文件编辑器支持 INI 格式
    * 【系统】登录页面用户名输入框增加用户名属性以方便密码管理器识别

!!! note "问题修复 :palm_tree:"

    * 【网站】修复了反向代理网站源文本中包含注释时解析错误的问题
    * 【数据库】修复了 MySQL 远程访问选项状态异常的问题
    * 【容器】修复了清理镜像时未检查镜像使用状态的问题
    * 【文件】修复了部分场景下文件编辑器保存提示信息异常的问题
    * 【计划任务】修复了部分场景下查看计划任务日志滚动光标无法锁定的问题
    * 【系统】修复了文档链接跳转异常的问题

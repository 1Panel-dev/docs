# Install phpMyAdmin Visually Using 1Panel

!!! note ""
    **phpMyAdmin** is an open-source web-based MySQL database management tool that allows users to manage MySQL databases via a web browser.
...
!!! note ""
    ...
    - **Name**: Customize the application name (default: phpmyadmin)
    - **Version**: Select the desired phpMyAdmin version from the dropdown
    - **Port**: Access port for the application (default: 8089)
...
## 4. Access the phpMyAdmin Service

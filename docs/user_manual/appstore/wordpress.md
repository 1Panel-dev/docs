# Install WordPress Visually Using 1Panel
...
!!! note ""
    ...
    - **Name**: Customize the application name (default: wordpress)
    - **Version**: Select the desired WordPress version from the dropdown
    - **Database Service**: Select the MySQL service for data storage
    ...
    - **Port**: Access port for the application (default: 8080)
...
## 4. Access the WordPress Service

# Install Stirling-PDF Visually Using 1Panel
...
!!! note ""
    ...
    - **Name**: Customize the application name (default: stirling-pdf)
    - **Version**: Select the desired Stirling-PDF version from the dropdown
...
## 4. Access the Stirling-PDF Service

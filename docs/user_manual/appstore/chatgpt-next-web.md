# 使用 1Panel 可视化安装 ChatGPT-Next-Web
...
!!! note ""
    ...
    - **名称** (输入框内可自定义应用名称，默认为 chatgpt-next-web)
    - **版本** (下拉选择所需的 ChatGPT-Next-Web 版本)
    - **端口** (应用的访问端口，默认为 40042)
    - **OPENAI API KEY** (填入您的 OpenAI API 密钥)
    - **访问密码** (设置应用的访问密码，建议填写)
    - **代理地址** (设置 API 请求的代理服务器地址)
    - **API 接口地址** (设置 OpenAI API 的请求地址)
    - **webdev 白名单** (设置 WebDAV 访问的白名单)
